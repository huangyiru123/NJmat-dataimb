...
def xgboost_modify(a, b, c, d, e, f, g,path,csvName,cross):
    # 数据切分
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    ...
    if cross >= 2:
        ...
        plt.rcParams['xtick.direction'] = 'in'
        plt.rcParams['ytick.direction'] = 'in'
        plt.plot(range(1, cross+1), scores_fold, c='r')
        plt.scatter(range(1, cross+1), scores_fold, c='r')
        #     ax=plt.gca()
        ax.spines['bottom'].set_linewidth(2);  ###设置底部坐标轴的粗细
        ax.spines['left'].set_linewidth(2);  ####设置左边坐标轴的粗细
        ax.spines['right'].set_linewidth(2);  ###设置右边坐标轴的粗细
        ...
        plt.savefig(path + '/' + file_set_name, dpi=300, bbox_inches='tight')
        plt.close()
    else:
        scores=[-1]
    # 训练集也可以打印准确率并plot图
...
def RandomForest_modify(a, b, c, d, e,path,csvname,cross):
...
def Bagging_modify(a, b, c,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
...
def AdaBoost_modify(a, b, c,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties='Times New Roman',
             size=20, horizontalalignment='center')
    plt.savefig(path + '/AdaBoost-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def GradientBoosting_modify(a, b, c,d,e,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties='Times New Roman',
             size=20, horizontalalignment='center')
    plt.savefig(path + '/GradientBoosting-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def ExtraTree_modify(a, b, c,e,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties='Times New Roman',
             size=20, horizontalalignment='center')
    plt.savefig(path + '/ExtraTree-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
# 6.7.2 Svm自定义超参数建模画图
def Svm_modify(a, b,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.ylabel("Prediction", fontproperties = 'Times New Roman', size = 20)
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties = 'Times New Roman', size = 20, horizontalalignment='center')
    plt.savefig(path+'/Svm-modify-test.png', dpi=300, bbox_inches = 'tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def DecisionTree_modify(a, b,c,d,e,f,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.ylabel("Prediction", fontproperties = 'Times New Roman', size = 20)
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties = 'Times New Roman', size = 20, horizontalalignment='center')
    plt.savefig(path+'/DecisionTree-modify-test.png', dpi=300, bbox_inches = 'tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def LinearRegression_modify(a, b,c,d,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.ylabel("Prediction", fontproperties = 'Times New Roman', size = 20)
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties = 'Times New Roman', size = 20, horizontalalignment='center')
    plt.savefig(path+'/LinearRegression-modify-test.png', dpi=300, bbox_inches = 'tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def Ridge_modify(a, b,c,d,e,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.ylabel("Prediction", fontproperties = 'Times New Roman', size = 20)
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties = 'Times New Roman', size = 20, horizontalalignment='center')
    plt.savefig(path+'/Ridge-modify-test.png', dpi=300, bbox_inches = 'tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def MLP_modify(l,a,m,ha,hb,path,csvname,cross):
    from sklearn import preprocessing
    from sklearn.model_selection import KFold
    from sklearn.metrics import mean_squared_error
    from matplotlib.ticker import MultipleLocator, FormatStrFormatter
    ...
    plt.ylabel("Prediction", fontproperties = 'Times New Roman', size = 20)
    plt.text(.05, .2, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties = 'Times New Roman', size = 20, horizontalalignment='center')
    plt.savefig(path+'/MLP-modify-test.png', dpi=300, bbox_inches = 'tight')
    plt.close()
    # 使用KFold交叉验证建模
    from sklearn.model_selection import cross_val_score
    if cross >= 2:
...
def data_imbalance_randomforest_Classifier(a, b, c, d, e, f,path,csvName):
    # import matplotlib.pyplot as plot
    # import seaborn as sns
    # import matplotlib.pyplot as plt
    # from sklearn import svm
    ...
    # Classified_two_RF = clf.fit(X_train_res, y_train_res)
    #
    # # 画出ROC曲线 RandomForest test
    ...
    # plt.yticks(indices, [0, 1], fontsize=20)
    # plt.colorbar()
    # for first_index in range(len(C)):
    #     for second_index in range(len(C)):
    #         plt.text(first_index, second_index, C[first_index][second_index], fontsize=20, horizontalalignment='center')
    #     plt.savefig(path + '/RandomForest_test_CM.png', dpi=300, bbox_inches='tight')
    # plt.close()
    # print("true:", true)
    # str2 = "fpr:"+str(fpr) + '\n' + "tpr:"+str(tpr)+"\n"+"true:"+str(true)
    #
    # # 画出ROC曲线 RandomForest train
    # y_score = clf.predict_proba(X_train_res)
    # fpr, tpr, threshold = roc_curve(y_train_res, y_score[:, 1])
    # roc_auc = auc(fpr, tpr)
    # plt.figure()
    # lw = 2
    # plt.figure(figsize=(10, 10))
    ...
    # plt.close()
    #
    # # 画出混淆矩阵 RandomForest train
    # prey = clf.predict(X_train_res)
    # true = (prey == y_train_res).sum()
    # C = confusion_matrix(y_train_res, prey, labels=[0, 1])
    # plt.imshow(C, cmap=plt.cm.Blues)
    # indices = range(len(C))
    # plt.xticks(indices, [0, 1], fontsize=20)
    # plt.yticks(indices, [0, 1], fontsize=20)
...
def data_imbalance_extratrees_classifier(a, b, c, d, e, f,path,csvName):
    import matplotlib.pyplot as plot
    import seaborn as sns
    import matplotlib.pyplot as plt
    from sklearn import svm
    ...
    # 使用最佳参数训练模型
    best_params = grid_search.best_params_
    clf = ExtraTreesClassifier(max_depth=a, random_state=b, min_samples_leaf=c, max_features=d, min_samples_split=e,
                               n_estimators=f)
    clf.fit(X_train_res, y_train_res)
    Classified_two_ET = clf.fit(X_train_res, y_train_res)

    # 画出ROC曲线 Extra Trees test
    y_score = clf.predict_proba(X_test)
    fpr, tpr, threshold = roc_curve(y_test, y_score[:, 1])
    roc_auc = auc(fpr, tpr)
    plt.figure()
    ...
    pickle.dump(Classified_two_ET, open(path + "/Classified_two_ET.dat", "wb"))

    return str1, str2, str3



def data_imbalance_gaussianprocess_Classifier(a, b, c, d, e, path, csvName):
    import matplotlib.pyplot as plt
    import seaborn as sns
    from sklearn import svm
    import numpy as np
    ...
    for first_index in range(len(C)):  # 第几行
        for second_index in range(len(C)):  # 第几列
            plt.text(first_index, second_index, C[first_index][second_index], fontsize=20,
                     horizontalalignment='center')
    plt.savefig(path + '/GaussianProcess_test_CM.png', dpi=300, bbox_inches='tight')
    plt.close()
    print("true:", (prey == y_test).sum())
    str2 = "fpr:" + str(fpr) + '\n' + "tpr:" + str(tpr) + "\n" + "true:" + str((prey == y_test).sum())
    ...
    plt.savefig(path + '/GaussianProcess_train_CM.png', dpi=300, bbox_inches='tight')
    plt.close()
    print("true:", (prey == y_train_res).sum())
    str3 = "fpr:" + str(fpr) + '\n' + "tpr:" + str(tpr) + "\n" + "true:" + str((prey == y_train_res).sum())

    # 保存模型
    with open(path + "/Classified_two_GaussianProcess.dat", "wb") as f:
        pickle.dump(clf, f)

    return str1, str2, str3

def data_imbalance_DecisionTree_classifier(a, b, c, d, e,path,csvName):
    import matplotlib.pyplot as plt
    import seaborn as sns
    import numpy as np
    import pandas as pd
    ...
    def data_imbalance_decisiontree_Classifier(a, b, c, d, e, path, csvName):
        ...
        clf = DecisionTreeClassifier(criterion=criterion, max_depth=max_depth1, max_features=max_features_1,
                                     min_samples_leaf=d,
                                     min_samples_split=e)
        clf.fit(X_train_res, y_train_res)
        Classified_two_DecisionTree = clf
        ...
        for first_index in range(len(C)):
            for second_index in range(len(C)):
                plt.text(second_index, first_index, C[first_index][second_index], fontsize=20,
                         horizontalalignment='center')
        plt.savefig(path + '/DecisionTree_test_CM.png', dpi=300, bbox_inches='tight')
        plt.close()
        true_test = (prey == y_test).sum()
        print("true:", true_test)
        str2 = "fpr:" + str(fpr) + '\n' + "tpr:" + str(tpr) + "\n" + "true:" + str(true_test)

        # 画出ROC曲线 DecisionTree train
        y_score = clf.predict_proba(X_train_res)
        fpr, tpr, threshold = roc_curve(y_train_res, y_score[:, 1])
        roc_auc = auc(fpr, tpr)
        plt.figure()
        ...
        plt.savefig(path + '/DecisionTree_train_CM.png', dpi=300, bbox_inches='tight')
        plt.close()
        true_train = (prey == y_train_res).sum()
        print("true:", true_train)
        str3 = "fpr:" + str(fpr) + '\n' + "tpr:" + str(tpr) + "\n" + "true:" + str(true_train)

        # 保存模型
        with open(path + "/Classified_two_DecisionTree.dat", "wb") as f:
            pickle.dump(Classified_two_DecisionTree, f)

        return str1, str2, str3


def data_imbalance_SVM_classifier(a, b, c, d,e,path,csvName):
    import seaborn as sns
    import matplotlib.pyplot as plt
    from sklearn import svm
    import numpy as np
    ...
    print("Test accuracy:", grid_search.score(X_test, y_test))
    str1 = f"Best parameters: {grid_search.best_params_}" + "\n" + f"Test accuracy: {grid_search.score(X_test, y_test)}"
    # Assign optimized parameters to variables
    best_params = grid_search.best_params_
    kernel1 = best_params['kernel']
    gamma1 = best_params['gamma']
    degree1 = best_params['degree']
    C1 = best_params['C']
    # Define optimized SVM classifier
    clf = SVC(degree=a, kernel=kernel1, C=c, gamma=gamma1, probability=True)
    clf.fit(X, y)
    Classified_two_SVM = clf.fit(X, y)
    ...
    # Plot confusion matrix for SVM test
    clf.fit(X, y)
    prey = clf.predict(X_test)
    true = sum(prey == y_test)
    C = confusion_matrix(y_test, prey, labels=[0, 1])
    plt.imshow(C, cmap=plt.cm.Blues)
    indices = range(len(C))
    plt.xticks(indices, [0, 1], fontsize=20)
    ...
    # Plot confusion matrix for SVM train
    clf.fit(X, y)
    prey = clf.predict(X_train)
    true = sum(prey == y_train)
    C = confusion_matrix(y_train, prey, labels=[0, 1])
    plt.imshow(C, cmap=plt.cm.Blues)
    indices = range(len(C))
    plt.xticks(indices, [0, 1], fontsize=20)
